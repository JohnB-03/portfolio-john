...
export default function SkillsCard({ skill }: { skill: SkillsModel }) {
    ...
    return (
        <div>
            <Card className="w-100 h-110 border-2 bg-transparent shadow-2xl transition delay-150 duration-300 ease-in-out hover:shadow-[#F1895C] hover:scale-105 hover:-translate-y-1">
